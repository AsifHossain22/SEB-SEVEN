    ...
    >
      ...
      <div className="flex-1 max-w-xs hidden md:block">
        {showSearch ? (
          ...
          >
            ...
            <span className="ml-auto text-xs bg-slate-700 px-1.5 py-0.5 rounded font-mono">
              /
            </span>
          </button>
        )}
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        <div className="relative">
          <button
            onClick={() => setShowNotif(!showNotif)} // TogglePanel
